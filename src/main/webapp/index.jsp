...
<body>
	...
	<div class="container mt-5">
		<div class="row align-items-center">
			...
			<div class="col-6">
				<ul class="d-flex gap-5 d-flex align-items-center"
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content p-4">
					...
					<div class="modal-mody py-4 mt-4">
						<div class="mb-3">
							<label for="modal-email" class="form-label">Username</label> <input
								type="text" class="form-control" id="modal-email"
								placeholder="Enter username" name="username" />
						</div>
						<div class="mb-3">
							<label for="modal-email" class="form-label">Password</label> <input
								type="password" class="form-control" id="modal-password"
								placeholder="Enter Password" name="password" /> <i
								class="bi bi-eye-slash position-absolute top-60 end-0 translate-middle-y me-5"
								id="hiddenEye" style="padding-bottom: 2.5rem; cursor: pointer"></i>
						</div>
						<div id="campiFeedback" class="invalid-feedback"
					...
					<div class="pt-4 text-center">
						<span class="text-muted">Don't have an account? <a
							href="./registration.html" class="text-primary"
	...
	<div class="container">
		<div class="text-center mt-5 mb-2 py-5">
			<h2 class="text-muted" style="font-weight: bold">COURSE
				CATEGORIES</h2>
		...
		<div class="row">
			<div class="col-md-3">
				...
				<h5 class="mb-3">
					<a href="" style="text-decoration: none" class="text-muted">SCIENCE
						& TECHNOLOGY</a>
				</h5>
				<small class="text-secondary"> Lorem ipsum dolor sit amet,
					consectetur adipisicing elit. Error molestias molestiae vero vel
					libero voluptate. </small>
			</div>
			<div class="col-md-3">
				<img src="./img/c2.png" alt="" class="mb-4" />
				<h5 class="mb-3">
					<a href="" style="text-decoration: none" class="text-muted">HEALTH
						& PSYCHOLOGY</a>
				</h5>
				<small class="text-secondary"> Lorem ipsum dolor sit amet,
					consectetur adipisicing elit. Error molestias molestiae vero vel
			...
			<div class="col-md-3">
				...
				<h5 class="mb-3">
					<a href="" style="text-decoration: none" class="text-muted">BUSINESS
						& ACCOUNTING</a>
				</h5>
				<small class="text-secondary"> Lorem ipsum dolor sit amet,
					consectetur adipisicing elit. Error molestias molestiae vero vel
			...
			<div class="col-md-3">
				...
				<h5 class="mb-3">
					<a href="" style="text-decoration: none" class="text-muted">REAL
						ESTATE LAW</a>
				</h5>
				<small class="text-secondary"> Lorem ipsum dolor sit amet,
					consectetur adipisicing elit. Error molestias molestiae vero vel
	...
	<!-- Footer -->
	<footer class="text-center text-lg-start bg-light text-muted pt-4 mt-5">
		<section class="">
		...
		<div class="text-center p-4"
			...
			© 2021 Copyright: <strong>Itconsulting</strong>
		</div>
	</footer>
